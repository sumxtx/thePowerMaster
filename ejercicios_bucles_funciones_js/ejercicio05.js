...
duraciones solo de los álbumes de rock y luego imprime el 
total de estas duraciones por consola. */
...
function durationByGenreSum(list, sgenre)
{
  let sumDur = 0;
  for (i of list)
  {
...
console.log(durationByGenreSum(albums, "Rock"));
